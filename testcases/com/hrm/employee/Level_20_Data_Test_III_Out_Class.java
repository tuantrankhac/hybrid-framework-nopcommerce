...
public class Level_20_Data_Test_III_Out_Class extends BaseTest {
	...
	public void beforeClass(String browserName, String appUrl) {
		...
		dashboardPage = loginPage.loginToSystem(driver, "username", "password", Employee.Role.ADMIN_USERNAME, Employee.Role.ADMIN_PASSWORD);
	}
	...
	public void Employee_01_Add_New_Employee() {
		...
		addEmployeePage.enterEmployeeTextboxByName(driver, "firstName", Employee.AddEmployee.FIRSTNAME);

		log.info("Add_New - Step 04: Enter valid info to 'Last Name' textbox");
		addEmployeePage.enterEmployeeTextboxByName(driver, "lastName", Employee.AddEmployee.LASTNAME);
		...
		addEmployeePage.enterCreateLoginDetailsTextboxByText(driver, "Username", Employee.AddEmployee.USERNAME);

		log.info("Add_New - Step 07: Enter valid info to 'Password' textbox");
		addEmployeePage.enterCreateLoginDetailsTextboxByText(driver, "Password", Employee.AddEmployee.PASSWORD);

		log.info("Add_New - Step 08: Enter valid info to 'Confirm Password' textbox");
		addEmployeePage.enterCreateLoginDetailsTextboxByText(driver, "Confirm Password", Employee.AddEmployee.PASSWORD);
		...
		log.info("Add_New - Step 11: Verify succsess message is displayed");
		verifyTrue(addEmployeePage.isSuccessMessageDisplayed(driver, "Successfully Saved"));
		...
		employeeListPage.enterSeachTextboxByFieldName(driver, "Employee Name", Employee.AddEmployee.FULLNAME);
...
//		verifyEquals(employeeListPage.getValueInTableIDAtColumnNameAndRowIndex(driver, "resultTable", "First (& Middle) Name", "1"), empFirstName);
	...
	public void Employee_02_Upload_Avatar() {
		...
		dashboardPage = loginPage.loginToSystem(driver, "username", "password", Employee.AddEmployee.USERNAME, Employee.AddEmployee.PASSWORD);
	...
	public void Employee_03_Personal_Details() {
		...
		myInfoPage.enterEmployeeTextboxByName(driver, "firstName", Employee.PersonalDetail.FIRSTNAME);
		
		log.info("Personal_Details - Step 06: Enter new value to 'Last Name' textbox");
		myInfoPage.enterEmployeeTextboxByName(driver, "lastName", Employee.PersonalDetail.LASTNAME);
		...
		verifyEquals(myInfoPage.getTextboxValueByName(driver, "firstName"), Employee.PersonalDetail.FIRSTNAME);

		log.info("Personal_Details - Step 11:  Verify 'Last Name' textbox is updated success");
		verifyEquals(myInfoPage.getTextboxValueByName(driver, "lastName"), Employee.PersonalDetail.LASTNAME);
