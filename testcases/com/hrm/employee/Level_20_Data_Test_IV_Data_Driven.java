...
public class Level_20_Data_Test_IV_Data_Driven extends BaseTest {
	...
	public void Employee_01_Add_New_Employee() {
		...
		addEmployeePage.enterEmployeeTextboxByName(driver, "firstName", employeeData.getEmpFirstName());

		log.info("Add_New - Step 04: Enter valid info to 'Last Name' textbox");
		addEmployeePage.enterEmployeeTextboxByName(driver, "lastName", employeeData.getEmpLastName());
		...
		addEmployeePage.enterCreateLoginDetailsTextboxByText(driver, "Username", employeeData.getEmpUserName());

		log.info("Add_New - Step 07: Enter valid info to 'Password' textbox");
		addEmployeePage.enterCreateLoginDetailsTextboxByText(driver, "Password", employeeData.getEmpPassword());

		log.info("Add_New - Step 08: Enter valid info to 'Confirm Password' textbox");
		addEmployeePage.enterCreateLoginDetailsTextboxByText(driver, "Confirm Password", employeeData.getEmpPassword());
...
//		verifyEquals(employeeListPage.getValueInTableIDAtColumnNameAndRowIndex(driver, "resultTable", "First (& Middle) Name", "1"), empFirstName);
	...
	public void Employee_03_Personal_Details() {
		...
		myInfoPage.enterEmployeeTextboxByName(driver, "firstName", employeeData.getEditFirstName());
		
		log.info("Personal_Details - Step 06: Enter new value to 'Last Name' textbox");
		myInfoPage.enterEmployeeTextboxByName(driver, "lastName", employeeData.getEditLastName());
